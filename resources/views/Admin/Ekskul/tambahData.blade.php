...
<body>
    ...
    @if (session('AddEkskul'))
        <script>
            swal({
                title: "",
                text: "Berhasil menambah data ekskul",
                icon: "success",
            });
        </script>
    @endif
            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link active" href="{{ route('data.ekskul.create') }}" aria-expanded="false">
                                <span>
                                    <i class="fa-solid fa-file-circle-plus"></i>
                                </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 offset-md-2">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <form action="{{ route('data.ekskul.store') }}" method="POST">
                                                        @csrf
                                                        <div class="form-group mb-3">
                                                            <label>Nama Ekskul</label>
                                                            <input type="text" name="nama_ekskul"
                                                                placeholder="Masukkan Ekskul" class="form-control">
                                                        </div>

                                                        <div class="form-group mb-3">
                                                            <label>Kategori ekskul</label>
                                                            <select name="category" id=""
                                                                class="form-control">
                                                                <option selected hidden disabled>Silahkan Pilih Category
                                                                    Ekskul</option>
